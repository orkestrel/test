...
| `@orkestrel/scaffold`   | `0.0.76` | L3    | `@orkestrel/console` `^0.0.14`, `@orkestrel/emitter` `^0.0.10`, `@orkestrel/process` `^0.0.13`, `@orkestrel/contract` `^0.0.17`, `@orkestrel/markdown` `^0.0.15`, `@orkestrel/template` `^0.0.8`                                                                                                                           |                                                                |
